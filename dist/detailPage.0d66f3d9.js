...
Object.defineProperty(exports, "getMovie", {
  enumerable: true,
  get: function () {
    return _detailpage.getMovie;
  }
});
Object.defineProperty(exports, "renderDetailMovies", {
  enumerable: true,
  get: function () {
    return _detailpage.renderDetailMovies;
  }
});
var _detailpage = require("./detailpage.js");
...
function _getMovie() {
  _getMovie = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    var res, json;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("https://omdbapi.com/?apikey=7035c60c&i=".concat(id, "&plot=full"));
          case 2:
            res = _context.sent;
            _context.next = 5;
            return res.json();
...
function renderDetailMovies(movie) {
  ...
  var el = document.querySelector('.detailpage');
  ...
  var ratingContent = document.createElement('div');
  var ratingTitle = document.createElement('h3');
  ratingTitle.textContent = 'Ratings';
  ratingContent.append(ratingTitle);

  // actors content
  var actorsContent = document.createElement('div');
  var actorsTitle = document.createElement('h3');
  ...
  var directorTitle = document.createElement('h3');
  ...
  for (var i = 0; i < movie.Ratings.length; i++) {
    ...
    rating.classList.add("rating".concat(i));
    ratingImg.classList.add("rating--img".concat(i));
    ratingImg.src = "../images/Rating".concat(i, ".png");
...
},{"./detailpage.js":"js/detailpage.js"}],"js/detailPage.js":[function(require,module,exports) {
"use strict";
...
},{"./detailpage.js":"js/detailpage.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/detailPage.0d66f3d9.js.map