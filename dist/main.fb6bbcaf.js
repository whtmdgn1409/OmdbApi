...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/infoPage.js":[function(require,module,exports) {
"use strict";
...
exports.renderInfoMovies = renderInfoMovies;
...
function renderInfoMovies(movie) {
  ...
  var el = document.querySelector('.infoContent');
  ...
  for (var i = 0; i < movie.Ratings.length; i++) {
    ...
    ratingImg.src = "./img/rating".concat(i, ".png");
...
var _infoPage = require("./infoPage.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
  var moviesEl, moreBtnEl, page, maxPage, movie_value, searchBtn, movieOption, countOption, yearOption, y, movieYear, removeMovie, getMovies, _getMovies, errorMovie, renderMovies;
  return _regeneratorRuntime().wrap(function _callee5$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          renderMovies = function _renderMovies(movies) {
            ...
            try {
              var _loop = function _loop() {
                ...
                var yearEl = document.createElement('h3');
                var valueEl = document.createElement('h3');
                    ...
                    while (1) {
                      switch (_context3.prev = _context3.next) {
                        case 0:
                          ...
                          _context3.next = 4;
                          return (0, _infoPage.getMovie)(movieID);
                        case 4:
                          dMovie = _context3.sent;
                          ...
                          infoBtn.href = "/#".concat(movieID);
                          removeMain = document.querySelector('.searchpage');
                          infoBtn.addEventListener('click', function () {
                            setTimeout(function () {
                              window.scrollTo(0, document.body.scrollHeight);
                            }, 100);
                            removeMain.classList.add('search__remove');
                            (0, _infoPage.renderInfoMovies)(dMovie);
                          });
          ...
          errorMovie = function _errorMovie(error) {
            var errorText = document.createElement('h3');
            errorText.classList.add('error__text');
            errorText.textContent = error;
            moviesEl.append(errorText);
          };
          _getMovies = function _getMovies3() {
            _getMovies = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
              var page,
                title,
                type,
                year,
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      ...
                      title = _args4.length > 1 ? _args4[1] : undefined;
                      type = _args4.length > 2 ? _args4[2] : undefined;
                      year = _args4.length > 3 ? _args4[3] : undefined;
                      _context4.next = 6;
                      return fetch("https://omdbapi.com/?apikey=7035c60c&s=".concat(title, "&page=").concat(page, "&type=").concat(type, "&y=").concat(year));
                    case 6:
                      res = _context4.sent;
                      _context4.next = 9;
                      return res.json();
                    case 9:
                      ...
                      movies = json.Search, totalResults = json.totalResults;
                      maxPage = Math.ceil(Number(totalResults) / 10);
                      if (page >= maxPage) {
                        moreBtnEl.classList.add('remove');
                      }
                      return _context4.abrupt("return", renderMovies(movies));
                    case 17:
          ...
          getMovies = function _getMovies2() {
            return _getMovies.apply(this, arguments);
          };
          removeMovie = function _removeMovie() {
            var removeDiv = document.getElementById('remove_movie');
          ...
          moreBtnEl = document.querySelector('.more_btn');
          moreBtnEl.classList.add('remove');
          page = 1;
          maxPage = -1;
          movie_value = document.querySelector('.movie_input');
          searchBtn = document.querySelector('.search_btn');
          movieOption = document.getElementById('movie_option');
          countOption = document.getElementById('count_option');
          yearOption = document.getElementById('year_option'); // year
          for (y = 2022; y >= 1985; y -= 1) {
            movieYear = document.createElement('option');
          ...
          // search btn click
          searchBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
            var title, type, year, i;
...
},{"./infoPage.js":"js/infoPage.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
